...
export default function CreateFeed() {
  ...
  const [feed, setFeed] = useState<Omit<Feed, "FeedId">>({
    FeedName: "",
    Type: "",
    Description: "",
    Quantity: 0,
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto bg-green-50 border border-green-200 rounded-lg p-6 text-center">
          ...
          <h2 className="text-xl font-bold text-green-800 mb-2">Feed Created Successfully!</h2>
          <p className="text-green-700 mb-4">Your feed has been added to the inventory.</p>
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-2xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Add New Feed</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                placeholder="Enter feed description, nutritional information, and usage instructions"
              />
            </div>
          </div>
